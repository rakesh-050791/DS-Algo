...
class Solution:
    #Sort the given array, and calculate the difference between ith element and 
    # (i+B-1)th element (in a iteration) and update the result.
    ...
    def solve(self, A, B):
        ...
        for i in range(n - B + 1):
            minMaxDiff = A[i + B - 1] - A[i]
            minDifference = min(minDifference , minMaxDiff)
