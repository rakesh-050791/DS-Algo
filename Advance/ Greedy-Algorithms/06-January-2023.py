...
class Solution:
    ...
    # @return an integer
    def seats(self, A):
      ##creating the list of people sitted location in the given string 
       people = []
       for i in range(len(A)):
            if A[i] == "x":
                people.append(i)

       ## finding the mid location in people list
       mid = len(people)//2
        
      ## finding the minimum count to arrange them to sit together
       count = 0
